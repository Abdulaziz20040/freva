...
export default function OrderPage() {
  ...
  const onFinish = async () => {
    ...
    const malumotlar = {
      ...
      "Aloqa turi": values.contactMethod,
          ...
          {current === 0 && (
            <>
              ...
              <Form.Item
                name="contactMethod"
                label="Aloqa turi"
                rules={[{ required: true, message: "Aloqa turini tanlang" }]}
              >
              ...
              <Form.Item
                ...
                rules={[{ required: true, message: "Iltimos, vaqtni tanlang" }]}
              >
                <Select placeholder="Tanlang">
